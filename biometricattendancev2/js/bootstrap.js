...
+function ($) {
  ...
  Dropdown.prototype.keydown = function (e) {
    ...
    let $items = $parent.find('[role="menu"]' + desc + ', [role="listbox"]' + desc)
  ...
  Tooltip.prototype.show = function () {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      if (autoPlace) {
        ...
        let $container   = this.options.container ? $(this.options.container) : this.$element.parent()
        let containerDim = this.getPosition($container)
